        ...
        <section className="bg-slate-50 pt-32 pb-20">
            <div className="container mx-auto px-6 text-center">
                <h1 className="text-4xl md:text-6xl font-extrabold text-gray-900 leading-tight">
                    ...
                    <span className="text-3xl md:text-5xl">Soluciones desde la raíz</span>
                </h1>
                ...
                <div className="mt-8 flex flex-col md:flex-row items-center justify-center gap-4 max-w-2xl mx-auto">
                    <Link to="/financiacion" className="flex items-center gap-2 bg-gradient-to-r from-indigo-600 to-purple-600 px-6 py-3 rounded-lg shadow-xl transform hover:scale-105 transition-transform cursor-pointer">
                        <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                        </svg>
                        <span className="text-white font-bold text-lg">Opciones de autofinanciación</span>
                    </Link>
                    <div className="flex items-center gap-2 bg-white px-6 py-3 rounded-lg shadow-md">
                        ...
                        <span className="text-gray-800 font-semibold">Nos adaptamos desde autónomos, PYMES hasta grandes corporaciones</span>
                    </div>
                </div>
                <div className="mt-10">
